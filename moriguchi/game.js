...
var posi = [  { x: 5, y: -20},{ x: 5, y: 50},{ x: 5, y: 100},{ x: 5, y: 125},{ x: 5, y: 150},{ x: 5, y: 175},{ x: 5, y: 200},{ x: 5, y: 270},{ x: 5, y: 350},{ x: 5, y: 400},{ x: 5, y: 450},
              { x: 5, y: 500},{ x: 5, y: 550},{ x: 5, y: 600}]
var css_info = ["34px'ＭＳ ゴシック'","24px'ＭＳ ゴシック'","14px'ＭＳ 明朝'","14px'ＭＳ 明朝'","14px'ＭＳ 明朝'","14px'ＭＳ 明朝'","14px'ＭＳ 明朝'","24px'ＭＳ ゴシック'","14px'ＭＳ 明朝'","14px'ＭＳ 明朝'","14px'ＭＳ 明朝'",
